...
{
    [Activity(Label = "Hangman_Game_Activity")]
    public class Hangman_Game_Activity : Activity
    {
        ...
        protected override void OnCreate(Bundle savedInstanceState)
        {
            ...
            SetContentView(Resource.Layout.Game_Gm_Layouta);
            LoadDictionaryWords();
        ...
        {
            StartActivity(typeof(View_All_Activity));
        }
